...
const ControlGroup = () => {
  ...
  return (
    <div className='form-page'>
      <h2 className='form-page__description'>Control group</h2>
      <div className='form-page__content'>
        ...
        <div className='form-page__box'>
          ...
          <p className='grid-row cell-link'><NavLink to={'/control-group-global'}>Глобальная контрольная группа</NavLink>
          </p>
          <p className='grid-row'>Draft</p>
          <p className='grid-row cell-svg'>{svgDelete}</p>
          <p className='grid-row cell-link'><NavLink to={'/control-group-steps'}>Контрольная группа - 1. Avg bill: 0-999</NavLink>
          </p>
